...
def parse_args():
    ...
    parser.add_argument('--use_pretrain', type=int, default=1,help='0: No pretrain, 1: Pretrain with stored model.')
    parser.add_argument('--pretrain_embedding_dir', nargs='?', default='data/pretrain/',help='Path of learned embeddings.')
    parser.add_argument('--pretrain_model', nargs='?', default='pre-training_model_epoch',help='Path of stored model.')
    
    parser.add_argument('--pretrain_epoch', type=int, default=500,help='Path of stored model.')
    ...
    parser.add_argument('--milestone_score', type=float, default=0.5,help='The condition of link score.')

    parser.add_argument('--n_epoch', type=int, default= 100,help='Number of epoch.')
    parser.add_argument('--epoch_data_rate', type=float, default=1,help='Sampling data rate for each epoch.')
    ...
    args.pretrain_model_path = f"{args.save_dir}{args.pretrain_model}{args.pretrain_epoch}.pt"
