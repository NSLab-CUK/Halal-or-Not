...
def parse_args():
    ...
    parser.add_argument('--model_epoch', nargs='?', default=500,
                        help='The epoch to test.')
    
    parser.add_argument('--finetune_model_epoch', nargs='?', default=100,
                        help='The epoch to test.')
    ...
    parser.add_argument('--prediction_dict_file', nargs='?', default='disease_dict.pickle', help='Disease dictionary file')
